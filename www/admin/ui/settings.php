...
<html>
  ...
  <body class="skin-green sidebar-mini sidebar-collapse">
    <div class="wrapper">
      ...
      <include href="ui/template/top.php" />
      <include href="ui/template/menu.php" />
                ...
                <div class="box-body">
                  <table id="players_list" class="table table-hover table-stripped">
                    ...
                    <tbody>
                      ...
                      <repeat group="{{ @adminList }}" value="{{ @value }}">
                        <tr>
                ...
                <form class="form-horizontal" method="POST">
                  <div class="box-body">
                   ...
                   <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="real_name" value="{{ @currentUser.real_name }}" required="required" >
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="email" class="form-control" name="email" value="{{ @currentUser.email }}" required="required">
                      </div>
                    </div>
      ...
      <include href="ui/template/footer.php" />
